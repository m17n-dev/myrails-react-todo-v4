resource "aws_s3_bucket" "private" {
  bucket = "private-pragmatic-terraform-2023050801"
...
#   bucket = "public-pragmatic-terraform-2023050801"
#   acl    = "public-read"
...
resource "aws_s3_bucket" "alb_front_react_log" {
  bucket = "alb-front-react-v4-log-pragmatic-terraform-2023050801"
...
resource "aws_s3_bucket" "alb_rails_api_log" {
  bucket = "alb-rails-api-v4-log-pragmatic-terraform-2023050801"
...
resource "aws_s3_bucket" "artifact" {
  bucket = "artifact-pragmatic-terraform-2023050801"
...
resource "aws_s3_bucket" "operation" {
  bucket = "operation-pragmatic-terraform-2023050801"
...
resource "aws_s3_bucket" "cloudwatch_logs" {
  bucket = "cloudwatch-logs-pragmatic-terraform-2023050801"
